...
call reportgenerator "-title:Forestry Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Forestry Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for Forestry
call OpenCppCoverage.exe --export_type=binary:forestry_tests_unit_win.cov --sources src\forestry\src --sources src\forestry\header --sources src\tests\forestry -- build_win\build\Debug\forestry_tests.exe

echo Generate Test Coverage Data for Forestry App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=forestry_tests_unit_win.cov --export_type=cobertura:forestryapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\forestry\src --sources src\forestry\header --sources src\forestryapp\src --sources src\forestryapp\header --sources src\tests\utility --sources src\tests\forestry -- build_win\build\Debug\forestryapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:Forestry Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/forestryapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/forestry/src;src/forestry/header;src/forestryapp/src;src/forestryapp/header;src/tests/utility;src/tests/forestry" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/forestryapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/forestry/src;src/forestry/header;src/forestryapp/src;src/forestryapp/header;src/tests/utility;src/tests/forestry" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\forestry\header "build_win\build\Release" /E
call robocopy src\forestryapp\header "build_win\build\Release" /E
...
call robocopy src\forestry\header "build_win\build\Debug" /E
call robocopy src\forestryapp\header "build_win\build\Debug" /E
